# Contributing to AsyncVoterSlackCommand
...
In addition to this guide, you can check out a discussion of the project structure and techniques used in [AsyncVoter Development Guide](./DEVELOPING.md)
